    ...
    <main class="flex-1 p-6 max-w-[1344px] w-full mx-auto">
        ...
        <div class="mb-10">
            <x-noema-page-head>
                ...
                <x-slot name="center">
                    <button type="button" class="btn btn-primary btn-sm btn-square shrink-0 rounded-none" id="biography-create-open" title="Новая биография" aria-label="Новая биография">
                ...
                <x-slot name="actions">
                    ...
                    @include('partials.activity-log-button', ['world' => $world, 'biographiesModuleJournal' => true])
                </x-slot>
            </x-noema-page-head>
