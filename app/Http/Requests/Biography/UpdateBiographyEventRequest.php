...
class UpdateBiographyEventRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        $event = $this->route('biographyEvent');

        return $world && $biography && $event
            && (int) $this->user()->id === (int) $world->user_id
            && (int) $biography->world_id === (int) $world->id
            && (int) $event->biography_id === (int) $biography->id;
    }
